...
/******************** Clients ********************/
module.exports.findClientById = function(client_id, user_id) {
    return Client.findOne({client_id: client_id, user_id: ObjectID(user_id)});
};

module.exports.findClientByClientId = function(client_id) {
    return Client.findOne({client_id: client_id});
};

module.exports.findClients = function(user_id) {
    return Client.findOne({user_id: ObjectID(user_id)});
};
