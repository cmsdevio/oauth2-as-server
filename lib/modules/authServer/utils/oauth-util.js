...
module.exports.validateDcrGrantResponseTypes = (dcrGrantType, dcrResponseType) => {
    switch (dcrGrantType) {
    case 'client_credentials':
        return dcrResponseType === 'token';
    case 'authorization_code':
        return dcrResponseType === 'code';
    default: return false;
    }
    // const grantTypeIsValid = (dcrGrantType === 'authorization_code' && dcrResponseType !== 'code');
    // const responseTypeIsValid = (!(dcrGrantType.includes('client_credentials') && dcrResponseType !== 'token'));
