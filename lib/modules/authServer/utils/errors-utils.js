...
module.exports = class MissingBasicAuthCredentialsError extends ExtendableError {
    constructor(message) {
...
module.exports = class InvalidCodeError extends ExtendableError {
...
module.exports = class RequestKeyCacheError extends ExtendableError {
    constructor(message, code) {
