...
module.exports.generateOAuthToken = (
    ...
    const config = {
        headers: {
            Authorization: 'Bearer $2a$10$ym4zQ1McE9I3Y/GgoDtUpeeLYZFtXufddWN3flbZHE1JP3gy57NaK'
        }
    };
    axios.post('https://localhost:8443/api/account', { idtn1: clientId, idtn2: jtiValue }, config)
        .then((response) => {
