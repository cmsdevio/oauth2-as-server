...
module.exports.processTokenRequest = async (request, h) => {
    ...
    try {
            ...
            Models
                ...
                .then((code) => {
                    if (!Code.isCodeValid(code, codeValue, clientId)) {
                        ...
                        return h(Boom.unauthorized('invalid_or_expired_code'));
                    }
                    ...
                    request.log([ 'oauth2-token' ], `Issuing authorization code token: ${ JSON.stringify(tokenResponse) }.`);
                                ...
                                .then((token) => {
                                    ...
                                    Models
                                        ...
                                        .then(() => {
                                            ...
                                            return h(Boom.internal());
                                        });
                                }, (err) => {
                                    request.log([ 'oauth2-token-error' ], `Error persisting token ${ tokenResponse }: ${ err }.`);
                                    return h(Boom.internal());
                                });
                        }, (err) => {
        ...
        if (err instanceof InvalidClientError) {
            ...
            return h(Boom.unauthorized('invalid_client'));
        }
