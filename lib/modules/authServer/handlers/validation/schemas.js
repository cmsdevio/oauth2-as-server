...
const response_types = Joi.array().items(Joi.string());
const response_type = Joi.string().allow('code', 'token', ' ').optional();
const scope = Joi.string().allow('').optional();
...
const grant_types = Joi.array().items(Joi.ref('grant_type'));
