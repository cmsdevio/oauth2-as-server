...
module.exports.registerClient = async (request, h) => {
    ...
    try {
        ...
        if (err.code === 11000) {
            return h(Boom.badRequest('ClientUtils already exists.'));
        }
...
module.exports.getAuthorize = async (request, h) => {
    ...
    try {
        ...
        ClientUtils.validateClient(client, redirect_uri, clientId, null, null, requestedScopes);
        ...
        const urlParsed = buildUrl(clientRedirectUri || redirect_uri, {
