...
module.exports.getAuthorize = async (request, h) => {
    ...
    const redirectURIs = request.query.redirect_uris;
    ...
    try {
        ...
        ClientUtils.validateClient(client, redirectURIs, clientId, null, null, requestedScopes);
        ...
        const urlParsed = UrlUtils.buildUrl(clientRedirectUri || redirectURIs, {
