...
module.exports.registerClient = async (request, reply) => {
...
module.exports.getAuthorize = (request, reply) => {
    const Models = request.server.app.db;
...
module.exports.clientApproval = (request, reply) => {
    const Models = request.server.app.db;
