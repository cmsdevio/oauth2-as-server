...
module.exports.getClients = async (request, h) => {
...
module.exports.addClient = async (request, h) => {
    const user = { ...request.auth.credentials };
    const Models = request.server.app.db;
    ...
    clientData.client_id = TokenUtils.generateTokenString(100);
    clientData.client_secret = TokenUtils.generateTokenString(100);
