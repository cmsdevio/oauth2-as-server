...
exports.plugin = {
    register: (server, options) => {
        ...
        server.app.db = {
            ...
            findCodeByValue: value =>
                new Promise((resolve, reject) => resolve(codesMap.get(value))),
            deleteCodeByClientId: clientId => new Promise((resolve, reject) => resolve(true)),
            saveRefreshToken: refreshToken => new Promise((resolve, reject) => {
                console.log(`Saving refresh token with key ${ refreshToken.client_id }.`);
                refreshTokenMap.set(refreshToken.client_id, refreshToken);
