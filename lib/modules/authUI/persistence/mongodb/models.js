...
const Client = Mongoose.model('ClientUI', clientSchema);
const Code = Mongoose.model('CodeUI', codeSchema);
const Token = Mongoose.model('TokenUI', tokenSchema);
const User = Mongoose.model('UserUI', userSchema);
