...
exports.register = (server, options, next) => {
    ...
    server.route({
        ...
        path: '/clients',
        handler: (request, reply) => {
            console.log('Token for clients GET: ' + request.auth.credentials.token);
                ...
                if (err) {
                    ...
                    reqCacheClient.drop(key, (err) => {
                        ...
                        Wreck.post(apiBaseUrl + '/login', {
                            ...
                            request.cookieAuth.set({token: payload.token});
                            // TODO: redirect to dashboard
